...
// import 'package:stadium_app_task/src/feature/connection/view/pages/connewction_page.dart';
        ...
        child: InhertedConnectionNotifair(
          ...
          child: Builder(builder: (context) {
            return MaterialApp(
              theme: InheritedThemeNotifier.maybeOf(context)?.theme,
                debugShowCheckedModeBanner: false,
              home: InhertedConnectionNotifair.maybeOf(context)!.isDeviceConnectionEnable ? const HomePage() : const ConnectionPage(),
            );
          }),
        ),
      );
